...
# 從環境變數獲取允許的 CORS 來源，如果未設定則預設為開發環境的 Vercel URL
# 在生產環境中，請務必設定此環境變數為您的 Vercel 前端網址
ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'https://etf-smart-advisor-m7mmzfggo-etfapps-projects.vercel.app').split(',')
